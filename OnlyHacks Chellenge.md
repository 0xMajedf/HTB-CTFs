...
2. register a new account with any username and password and email u want

3. get redirected to /dashboard

4. naviagte to http://IP:PORT/chat/?rid=6 

5. change the number from 6 to 3 and u got the flag
